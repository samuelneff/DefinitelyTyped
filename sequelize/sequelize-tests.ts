...
interface DaoInstance extends SequelizeInstance<DaoInstance, DaoPojo>, DaoPojo
{
}

interface DaoModel extends SequelizeModel<DaoInstance, DaoPojo>
{
}

var sequelize:Sequelize = new Sequelize('testsdb', 'root', null, { logging: false, define: { underscored:true } })
    , Dao:DaoModel = sequelize.define<DaoInstance, DaoPojo>('dao', {name: "string"});
